...
*/
  ...
  function Cb(a, b) {
    xb ? a[xb] && (a[xb] &= ~b) : void 0 !== a.P && (a.P &= ~b)
  }
  function Ab(a) {
    var b
    xb ? (b = a[xb]) : (b = a.P)
...
*/
  ...
  function Bf(a) {
    return JSON.stringify([
      a.map(function (b) {
        var c = {}
        return [((c[b.hb] = b.message.toJSON()), c)]
      }),
    ])
  }
  function Cf(a, b) {
  ...
  Kf.prototype.cb = function () {
    var a = Ea.apply(0, arguments),
      b = this
    this.A && 65536 <= Bf(this.h.concat(a)).length && Mf(this)
    this.h.push.apply(this.h, ka(a))
    this.h.length >= this.m && Mf(this)
    this.h.length &&
      null === this.i &&
  ...
  function Vf(a, b) {
    switch (b) {
      case 1:
        return I(a, Tb(a, Pe, 1))
      case 2:
        return I(a, Tb(a, Pe, 2))
      case 3:
        return I(a, Tb(a, Pe, 3))
      case 6:
        return I(a, Tb(a, Pe, 6))
      default:
        return null
    }
  }
  ...
  function ag(a) {
    var b = N(Tf).H
    if (b) {
      var c = ib(F(a, Me, 5), function (f) {
        return Je(E(f, Be, 1), b)
      })
      if (c) {
        var d
        return null != (d = E(c, Ke, 2)) ? d : null
      }
    }
    var e
    return null != (e = E(a, Ke, 4)) ? e : null
  }
  function Zf() {
    this.i = {}
    this.l = []
    ...
    db(b, function (h) {
      ...
      db(a, function (l) {
        ...
        if (p) {
          ...
          if ((z = m)) {
            var G
            z = !(null == (G = N(Zf).j[h]) || !G.has(p))
          }
          z && f.push(m)
          if ((G = m)) {
            var Y
            G = !(null == (Y = N(Zf).h.get(h)) || !Y.has(p))
          }
          G && g.push(m)
          e ||
            ((Y = N(Zf)),
  ...
  function qg(a, b, c) {
    a.j = lg(1, b, function () {})
    a.l = function (d) {
      return lg(2, b, function () {
        return []
      })(d, c)
    }
    a.i = function () {
      return lg(3, b, function () {
        return []
      })(c)
    }
    a.h = function (d) {
      lg(16, b, function () {})(d, c)
    }
  }
  var rg,
    sg,
  ...
  wg.prototype.reject = function (a) {
    yg(this)
    this.h = 2
    this.j = a
    zg(this.i)
  ...
  n.filter = function (a) {
    return new Ag(eb(this.h, a))
  }
  n.apply = function (a) {
    return new Ag(a(this.h.slice(0)))
  }
  n.sort = function (a) {
    return new Ag(this.h.slice(0).sort(a))
  }
  n.get = function (a) {
    return this.h[a]
  }
  ...
  var Ng = [4]
  function Og(a) {
    var b = void 0 === a.Qa ? void 0 : a.Qa,
      c = void 0 === a.sb ? void 0 : a.sb,
      d = void 0 === a.bb ? void 0 : a.bb
  ...
  w(Sg, J)
  Sg.prototype.setLocation = function (a) {
    return C(this, 1, a)
  }
  function Xg(a, b) {
    this.Ua = a
  ...
  function dh() {
    ...
    this.floatingAdsStacking = new eh()
  ...
  var Hh = new P(1082, !0),
    ...
    bi = new P(1162),
    ci = new P(1120),
    di = new Fh(501545963, 1),
    ei = new P(501545960),
    fi = new P(501545961),
    gi = new P(45388034),
    hi = new Fh(501545962, 1),
    ii = new Fh(45388309, -1),
    ji = new Fh(1114, 1),
    ki = new Fh(1110, 5),
    li = new Fh(1111, 5),
    mi = new Fh(1112, 5),
  ...
  function Q(a) {
    return N(Ei).i(a.h, a.defaultValue)
  }
  function R(a) {
    return N(Ei).j(a.h, a.defaultValue)
  }
  function Fi() {
    return N(Ei).l(Kh.h, Kh.defaultValue)
  }
  function Gi(a, b, c) {
    switch (c) {
      case 0:
  ...
  function Hi(a, b, c) {
    ...
    switch (b) {
      case 0:
        return {
          init: Ji(a.previousSibling, e),
          qa: function (f) {
            return Ji(f.previousSibling, e)
          },
          ta: 0,
        }
      case 2:
        return {
          init: Ji(a.lastChild, e),
          qa: function (f) {
            return Ji(f.previousSibling, e)
          },
          ta: 0,
  ...
  function Ri(a) {
    var b = 0,
      c
    for (c in Ki) -1 != a.indexOf(c) && (b |= Ki[c])
    return b
  }
  ...
  function nj(a, b, c) {
    return lj(a, b, void 0, c, !0).apply()
  }
  function oj(a) {
    if (!a) return null
    var b = B(a, 7)
  ...
  function Tj(a, b, c) {
    E(b, vh, 2)
      ? ((b = E(b, vh, 2)), (a = Sj(a, E(b, O, 1))) && c.set(La(a), B(b, 2)))
      : E(b, O, 1) &&
        (a = Vj(a, E(b, O, 1))) &&
  ...
  function Sj(a, b) {
    return (a = Vj(a, b)) && 0 < a.length ? a[0] : null
  }
  function Vj(a, b) {
    return (b = oj(b)) ? b.query(a) : null
  }
  function Wj() {
    this.h = new q.Set()
  }
  ...
  function ek(a) {
    return !!a.nextSibling || (!!a.parentNode && ek(a.parentNode))
  }
  function fk(a, b) {
    if (!a) return !1
    a = a.hash
  ...
  function lk(a, b, c, d, e) {
    ...
    this.i = c
    this.m = e || null
    this.A = (this.B = d) ? Rj(a.document, F(d, uj, 5)) : Rj(a.document, [])
    this.u = new Wj()
    this.j = 0
    this.l = !1
  }
  ...
  function pk(a, b, c, d) {
    ...
    if (!(f = null == e)) {
      a: {
        ...
        switch (e) {
          ...
          case 2:
            var g = d.lastChild
            f = ck(g ? (1 == g.nodeType ? g : dk(g)) : null, f)
            break a
        }
        f = !1
      }
    ...
    if (!c) {
      ...
      a: switch (f) {
        case 1:
          g = Xj(d.previousElementSibling) || Zj(d)
          break a
        case 4:
          g = Xj(d) || Zj(d.nextElementSibling)
          break a
        case 2:
          g = Zj(d.firstElementChild)
          break a
        case 3:
    ...
    c = E(b, wh, 3)
    f = {}
    c && ((f.gb = B(c, 1)), (f.Ta = B(c, 2)), (f.kb = !!Xb(c, 3)))
  ...
  function ok(a, b) {
    return a && void 0 !== Sb(a, Sg, 4, !1) && b[B(E(a, Sg, 4), 2)] ? !1 : !0
  }
  function rk(a) {
    J.call(this, a)
  }
  ...
  function vk(a) {
    ...
    x.google_measure_js_timing || ve(uk)
  }
  ;(function (a) {
    sk = a || new he()
  ...
  function Pk(a, b) {
    ...
    this.I = 0
    var c
    this.C = null != (c = b.fb) ? c : 500
    var d
    this.B = null != (d = b.Zb) ? d : !1
    this.m = null
  }
  w(Pk, M)
    ...
    try {
      switch (this.j.document.readyState) {
        ...
        case "interactive":
          ...
          break
        default:
          mk(this.h, !1) ? hl(this) : this.j.setTimeout(Qa(this.l, this), 100)
      }
    } catch (a) {
      hl(this, a)
    }
  ...
  w(vl, J)
  var wl = [11, 8, 12, 13, 15, 17, 19, 18, 20, 21, 22, 25, 26]
  function xl() {}
  function yl(a) {
    J.call(this, a, -1, zl)
  }
  ...
  Rc(ug).map(function (a) {
    return Number(a)
  })
  Rc(vg).map(function (a) {
    return Number(a)
  })
  function Il(a) {
    this.h = a
  ...
  function Jl(a) {
    a.__tcfapiPostMessageReady || Kl(new Il(a))
  }
  function Kl(a) {
    a.i = function (b) {
  ...
  function Qm(a) {
    ...
    a: if (((b = a.s), (c = a.j), (a = a.i), null == a ? 0 : Rb(a, bm, 13))) {
      ...
      if (null == a ? 0 : Rb(a, cm, 14)) {
        var k
        f = null == a ? void 0 : null == (k = pm(a)) ? void 0 : Yb(k, 1)
        var l, m
        g =
          null == a
            ? void 0
  ...
  function gn(a, b, c, d) {
    d && (sj(a).configSourceInAbg = d)
    if (void 0 !== Sb(c, zj, 24, !1)) {
      d = tj(a)
      d.availableAbg = !0
      var e, f
  ...
  var hn = {},
    jn =
      ((hn.google_ad_modifications = !0),
      (hn.google_analytics_domain_name = !0),
      (hn.google_analytics_uacct = !0),
      (hn.google_pause_ad_requests = !0),
      (hn.google_user_agent_client_hint = !0),
      hn)
  function kn(a) {
  ...
  function pn(a) {
    this.s = Rd() || window
    this.h = null != a ? a : new Of(100, 100, !0)
    if (Q(Ih))
      this.state = Hk(Dk(), 33, function () {
        var c = R(Jh)
        return {
          sd: c,
          ssp: 0 < c && ud() < 1 / c,
  ...
  ea.Object.defineProperties(pn.prototype, {
    i: {
      configurable: !0,
      enumerable: !0,
      get: function () {
  ...
  function An() {
    var a = N(Ei).h(Xh.h, Xh.defaultValue)
    Gd(a, L.document)
  }
  function Bn(a, b) {
    try {
  ...
  In.prototype.init = function (a, b, c, d) {
    var e = this,
      f = void 0 === d ? {} : d,
    ...
    db(e, function (k) {
      ...
      if ((k = Ln(a, k, c, l)))
        0 !== bc(l, qf) && h.push(l),
          ...
          d.push(l),
          Mn(a, l, g ? 4 : c),
          (k = F(k, Ne, 2)) && (g ? gg(k, ig(), a.J, l) : gg(k, [c], a.J, l))
    })
    Qf(a.J, b, c, d, h, 1)
    return d
  }
  ...
  function Ln(a, b, c, d) {
    ...
    d = e
      ? eb(f, function (k) {
          return Je(E(k, Be, 3), e)
        })
      : f
    if (!d.length) return null
    c = d.length * ic(b, 1)
    return (b = I(b, 4)) ? Qn(a, b, c, d) : Pn(a, d, c / 1e3)
  }
  function Qn(a, b, c, d) {
  ...
  function On(a, b) {
    ...
    c = c[d]
    e = N(Tf).H
    return !c || (e && !Je(E(c, Be, 3), e)) ? null : c
  }
  function Sn() {
    this.h = function () {}
  }
  function Tn(a, b) {
    a.h = lg(14, b, function () {})
  }
  function Un(a) {
    N(Sn).h(a)
  }
  ...
  function ao(a) {
    var b = a.ob,
      c = a.H,
      d = a.mb,
      e = void 0 === a.Ra ? zn() : a.Ra,
      f = void 0 === a.Sa ? 0 : a.Sa
    a =
      void 0 === a.J
        ? new Pf(
    ...
    e.hasOwnProperty("init-done")
      ? (lg(12, e, function () {})(
        ...
        lg(13, e, function () {})(
          fb(F(b, Ne, 1), function (g) {
            return g.toJSON()
          }),
          f
        ),
        c && lg(14, e, function () {})(c),
        bo(f, e))
      : (Rn(N(In).init(F(b, km, 2), f, a, d), e),
        mg(e),
        ng(e),
        og(e),
        bo(f, e),
        gg(F(b, Ne, 1), [f], a, void 0, !0),
        (Uf = Uf || !(!d || !d.tb)),
        Un(Gn),
        c && Un(c))
  }
  function bo(a, b) {
    var c = (b = void 0 === b ? zn() : b)
    qg(N(pg), c, a)
    co(b, a)
    a = b
    Tn(N(Sn), a)
  ...
  function co(a, b) {
    var c = N(Ei)
    c.i = function (d, e) {
      return lg(5, a, function () {
        return !1
      })(d, e, b)
    }
    c.j = function (d, e) {
      return lg(6, a, function () {
        return 0
      })(d, e, b)
    }
    c.l = function (d, e) {
  ...
  function fo(a, b, c) {
    ...
    if (d.plle) bo(1, zn(a))
      ...
      if ((c = kc(b, 15))) (c = Number(c)), N(pg).j(c)
      b = v(Wb(b, 19))
      for (c = b.next(); !c.done; c = b.next()) (c = c.value), N(pg).h(c)
      eo(12)
      eo(10)
      a = nd(a) || a
  ...
  var jo = {},
    ko =
      ((jo.image_stacked = 1 / 1.91),
      (jo.image_sidebyside = 1 / 3.82),
      (jo.mobile_banner_image_sidebyside = 1 / 3.82),
      (jo.pub_control_image_stacked = 1 / 1.91),
      (jo.pub_control_image_sidebyside = 1 / 3.82),
      (jo.pub_control_image_card_stacked = 1 / 1.91),
      (jo.pub_control_image_card_sidebyside = 1 / 3.74),
      (jo.pub_control_text = 0),
      (jo.pub_control_text_card = 0),
      jo),
    lo = {},
    mo =
      ((lo.image_stacked = 80),
      (lo.image_sidebyside = 0),
      (lo.mobile_banner_image_sidebyside = 0),
      (lo.pub_control_image_stacked = 80),
      (lo.pub_control_image_sidebyside = 0),
      (lo.pub_control_image_card_stacked = 85),
      (lo.pub_control_image_card_sidebyside = 0),
      (lo.pub_control_text = 80),
      (lo.pub_control_text_card = 80),
      lo),
    no = {},
    oo =
      ((no.pub_control_image_stacked = 100),
      (no.pub_control_image_sidebyside = 200),
      (no.pub_control_image_card_stacked = 150),
      (no.pub_control_image_card_sidebyside = 250),
      (no.pub_control_text = 100),
      (no.pub_control_text_card = 150),
      no)
  function po(a) {
    var b = 0
    a.X && b++
  ...
  function zo(a, b) {
    ...
    if (c.W) a = { ga: 0, fa: 0, T: 0, U: 0, X: "image_stacked", W: c.W }
      ...
      f = g
      c = c.U[d]
      d = Math.floor((((a - 8 * f - 8) / f) * ko[e] + mo[e]) * c + 8 * c + 8)
      a =
        1500 < a
          ? {
              width: 0,
  ...
  function Fo(a, b) {
    for (var c = Go.slice(0), d = c.length, e = null, f = 0; f < d; ++f) {
      var g = c[f]
      if (a(g)) {
        if (!b || b(g)) return g
        null === e && (e = g)
  ...
  function So(a, b, c, d, e) {
    ...
    switch (a) {
      case 5:
        return (
          (f = wk(247, function () {
            return Io(b, d.google_ad_format, e, c, d)
          })),
          (a = f.F),
          (f = f.G),
          !0 === f && b != a && Xi(e, c),
  ...
  function Xo(a) {
    var b = tk
    try {
      return Dc(a, ze), new nm(JSON.parse(a))
    } catch (c) {
  ...
  hp.prototype.J = function () {
    ...
    this.O ||
      (this.O = new PerformanceObserver(
        mj(640, function (b) {
          var c = kp !== window.scrollX || lp !== window.scrollY ? [] : mp,
            d = np()
          b = v(b.getEntries())
            ...
            switch (((e = e.value), e.entryType)) {
              case "layout-shift":
                if (!e.hadRecentInput) {
                  ...
                  var f = bp(e, c, d)
                  f && ((a.m += e.value), a.Ja++)
                  if (5e3 < e.startTime - a.Ia || 1e3 < e.startTime - a.La)
                    (a.Ia = e.startTime), (a.i = 0), (a.l = 0)
                  a.La = e.startTime
                  a.i += e.value
                  f && (a.l += e.value)
                  a.i > a.Z &&
  ...
  function np() {
    ...
    kp = window.scrollX
    lp = window.scrollY
    return (mp = [].concat(ka(a), ka(b)).map(function (c) {
  ...
  function pp(a, b, c) {
    ...
    b && qp() && this.i.push(W)
    c && this.i.push(X)
    if (document.hasTrustToken && !Q(zi)) {
      var e = new q.Map()
  ...
  function rp() {
    ...
    var b = N(Ei).h(Ci.h, Ci.defaultValue)
    Gd(b, a)
  }
  function sp(a, b) {
  ...
  function xp(a) {
    if (document.hasTrustToken && !Q(zi) && a.l) {
  ...
  w(Jp, J)
  Jp.prototype.getVersion = function () {
    return kc(this, 2)
  }
  var zp = [10, 6]
  var Kp =
  ...
  function Rp(a, b, c) {
    ...
    L.google_sa_queue ||
      ((L.google_sa_queue = []),
      (L.google_process_slots = xk(215, function () {
  ...
  function aq(a) {
    ...
    sp(rm(), kc(a, 8)) ||
      xk(779, function () {
        var b = window
        b = void 0 === b ? window : b
        b = Q(b.PeriodicSyncManager ? xi : yi)
        var c = Q(Ai)
        b = new pp(!0, b, c)
        0 < R(Di) ? (L.google_trust_token_operation_promise = xp(b)) : xp(b)
      })()
    a = Pp()
    null != a &&
      a.then(function (b) {
  ...
  function Gq(a, b, c) {
    var d = window
    d.google_spfd || (d.google_spfd = eq)
  ...
  function $q(a) {
    Id(function () {
      fh(x).wasPlaTagProcessed || (x.adsbygoogle && x.adsbygoogle.push(a))
    })
  }
  function Yq(a, b) {
  ...
  function gr() {
    for (var a = v(Cq), b = a.next(); !b.done; b = a.next()) {
      var c = v(b.value)
      b = c.next().value
      c = c.next().value
      ...
      Cq.has(b) ||
        ...
        wk(
          ...
          (function (d) {
            return function () {
              3 === d.ma
                ? Aq.handleAdConfig(d.ha)
                : 2 === d.ma && zk(730, Aq.handleAdBreakBeforeReady(d.ha))
            }
          })(a)
        ))
  }
