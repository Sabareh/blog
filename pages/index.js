...
export default function Home({ posts }) {
  return (
    <>
        ...
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="pt-6">
            <h1 className="pb-6 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
              Hi, I am{' '}
              <span className="text-primary-color-800 dark:text-primary-color-dark-500">
                Victor Sabare
              </span>
            </h1>
          ...
          <div className="flex items-center justify-center">
            <div className="grid grid-cols-1 grid-rows-3 gap-8 py-12">
              ...
              <div className="my-2 grid items-start gap-8">
                <div className="group relative">
                  <div className="animate-tilt absolute -inset-0.5 rounded-lg bg-gradient-to-r  from-pink-600 to-purple-600 opacity-50 blur transition duration-1000 group-hover:opacity-100 group-hover:duration-200"></div>
                  <Link href="https://drive.google.com/file/d/1X2r3lxWfWKKTYoN0Aapni6JFCzAVZNMv/view?usp=sharing">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      <span className="flex items-center space-x-5">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
      ...
      {siteMetadata.newsletter.provider === 'emailoctopus' ? (
        <div className="flex flex-col items-center justify-center pt-4">
          <div className="mb-3 text-xl font-semibold text-gray-800 dark:text-gray-100">
            Subscribe to my newsletter via EmailOctopus
          </div>
          <div className="mb-4 text-sm text-gray-600 dark:text-gray-400">
            Get updates on my latest posts and articles delivered directly to your inbox. Powered by
            EmailOctopus.
          </div>
          <NewsletterForm />
        </div>
